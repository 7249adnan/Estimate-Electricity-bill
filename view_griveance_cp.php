...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <title>View Grievance CP - Estimation</title>
    </head>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul id="item" class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li  class="nav-item dropdown active">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <b style="color:rgb(255, 251, 0) ;" ><i class="fas fa-server" style="font-size:24px;"></i> Griveance </b> 
                        </a>
                        <ul style="background-color: rgb(211, 165, 255);" class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
...
<br>
 ...
 <p id="head_bg"><b> &nbsp &nbsp &nbsp;&nbsp;&nbsp;&nbsp; Griveance BOX &nbsp</b></p>
 

    <br>
    
    <p id="title_bg_1"> Sr.no &nbsp E-mail id  &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp Number &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp &nbsp &nbsp Query &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp &nbsp Details  </p>
...
*/
    ...
    else
    {
        ...
        while($row =mysqli_fetch_assoc($result))
        {
            ...
            $query=$row['query'];
            $details=$row['explain_detail'];
            
            //echo "<br>";
            echo "<p id='title_bg_1_lb'>&nbsp&nbsp&nbsp $n &nbsp&nbsp&nbsp&nbsp $email &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $mobile &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $query &nbsp&nbsp&nbsp&nbsp&nbsp $details  </p>";
