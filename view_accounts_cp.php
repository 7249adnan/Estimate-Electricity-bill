...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <title>View Accounts CP - Estimation</title>
    </head>
...
<br>
 ...
 <p id="head_bg"><b> &nbsp &nbsp &nbsp;&nbsp;&nbsp;&nbsp;Estimate bills Accounts &nbsp</b></p>
 

    <br>
    
    <p id="title_bg_1"> Sr.no &nbsp E-mail id (PK) &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Number &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Password </p>
...
*/
    ...
    else
    {
        ...
        while($row =mysqli_fetch_assoc($result))
        {
            ...
            //echo "<br>";
            echo "<p id='title_bg_1_lb'>&nbsp&nbsp&nbsp $n &nbsp&nbsp&nbsp&nbsp $email &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $mobile &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp$password </p>";
