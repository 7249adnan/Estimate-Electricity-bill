...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  crossorigin="anonymous"></script>
    ...
    <title>Add Analysis - Estimation </title>
    </head>
...
var month = new Array();
    ...
    <p id="head_bg"><b>&nbsp&nbsp&nbsp<i class="fa fa-plus"></i>&nbsp Add Details  &nbsp</b></p>

    <br>  

    <label id="lbl" for="Month" class="form-label">Month</label>    
    <div class="input-group mb-3 row">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

        <div class="input-group-prepend">       
            <span class="input-group-text" id="sp"><i class="fa fa-calendar" style="font-size:20px"></i></span>
            <input required  onfocusout=" month_year()" name="mon_yr" id="mon_yr" 
    ...
    <div class="input-group mb-3 row">
        ...
        <div class="input-group-prepend">
            ...
            <input required min="1" step="1" onfocusout="est_pass()" name="est_bill" id="est_bill" type="number" value="" class="form-control "  placeholder="Estimated Amount" aria-label="Estimated Bill" aria-describedby="basic-addon1" />
    ...
    <div class="input-group mb-3 row">
        ...
        <div class="input-group-prepend">
            <span class="input-group-text" id="sp"><i class="fa fa-inr" style="font-size:20px;"></i></span>
            <input required min="1" step="1" onfocusout="cal_pass()" name="cal_bill" id="cal_bill" type="number" value="" class="form-control "  placeholder="Calculated Amount" aria-label="Estimated Bill" aria-describedby="basic-addon1" />
            <span class="input-group-text" id="sp"><b> INR </b></span>
...
function add_data_fun(){
    ...
    */
    ...
    { 
        ...
        if($n!=1){
            ...
            $sql="INSERT INTO `$email` (`months`, `cal_bill`, `est_bill`) VALUES ('$mon','$cal', '$est')";

            $result =mysqli_query($conn,$sql);

            echo "<script>alert('$mon'+ ' Details Added Successfully');</script>";

            /*
            if($mon)
            {          
            $sql = " UPDATE `$email` SET `months` = '$mon' WHERE `$email`.`months` = $mon";
            mysqli_query($conn,$sql);

            echo "<br>";
            echo " Months ".$mon." Updated succesfully";

            }

            if($est)
            {          
            $sql = " UPDATE `$email` SET `est_bill` = '$est' WHERE `$email`.`months` = $mon";
            mysqli_query($conn,$sql);

            echo "<br>";
            echo " Months ".$est." Updated succesfully";

            }

            if($cal)
            {          
            $sql = " UPDATE `$email` SET `cal_bill` = '$cal' WHERE `$email`.`months` = $mon";
            mysqli_query($conn,$sql);

            echo "<br>";
            echo " Months ".$cal." Updated succesfully";
 ...
 ?>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit"  id="add_data" name="add_data" class="btn btn-primary"><b><i class="fa fa-plus" style="font-size:18px"></i>&nbsp Add Data &nbsp</b></button>
    <br><br>
</form>
