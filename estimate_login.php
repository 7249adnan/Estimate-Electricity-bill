...
<style>
  ...
  .logo_outer img{
    ...
    &nbsp &nbsp<button type="submit" onClick="location.href='electric_login.php'"  name="back"  class="btn btn-danger "><b> <- Back</b> </button>
...
<form id="form1" action="estimate_api_login.php"  method ="POST" class=" p-2  mx-1 ">        
