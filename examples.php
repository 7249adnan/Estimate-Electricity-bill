...
$estimate = array(
	array("y" => 2300, "label" => "Jun 21 "),
	array("y" => 2400, "label" => "Jul 21 "),
	array("y" => 2200, "label" => "Aug 21 "),
	array("y" => 2000, "label" => "Sep 21 "),
	array("y" => 2400, "label" => "Oct 21 "),
	array("y" => 2500, "label" => "Nov 21 "),
	array("y" => 2400, "label" => "Dec 21 "),
    array("y" => 2500, "label" => "Jan 21 "),
	array("y" => 2600, "label" => "Feb 21 "),
	array("y" => 2800, "label" => "Mar 21 "),
	array("y" => 2900, "label" => "Apr 21 "),
	array("y" => 2900, "label" => "May 21 ")	
    
);

$calculate = array(
	array("y" => 2000, "label" => "Jun 21 "),
	array("y" => 2500, "label" => "Jul 21 "),
	array("y" => 2200, "label" => "Aug 21 "),
	array("y" => 2100, "label" => "Sep 21 "),
	array("y" => 2700, "label" => "Oct 21 "),
	array("y" => 2550, "label" => "Nov 21 "),
	array("y" => 2300, "label" => "Dec 21 "),
    array("y" => 2550, "label" => "Jan 21 "),
	array("y" => 2680, "label" => "Feb 21 "),
	array("y" => 2700, "label" => "Mar 21 "),
	array("y" => 2870, "label" => "Apr 21 "),
	array("y" => 3000, "label" => "May 21 ")	
);
...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  ...
  crossorigin="anonymous"></script>
    ...
    <title>Examples - Estimation</title>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [	
	{
		...
		name: "Calculated",
		dataPoints: <?php echo json_encode($calculate, JSON_NUMERIC_CHECK); ?>
	},

	{
		...
		yValueFormatString: "##. RS",
		name: "Estimated",
		dataPoints:<?php echo json_encode($estimate, JSON_NUMERIC_CHECK); ?>
