...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <title>View Tarrif Details CP - Estimation</title>
    </head>
...
<form id="form1"  method ="POST"  class=" container-fluid col-sm-8 ">

<br>

 <p id="head_bg"><b> &nbsp &nbsp &nbsp;&nbsp;&nbsp;&nbsp; Tarrif Table Structure &nbsp</b></p>
    ...
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" style="font-size:18px;" id="table_btn" name="table_btn" class="btn btn-primary"><b> Show Table</b></button>
    <br><br><br><br>

    <p id="title_bg_1"> Id &nbsp fix_chg  &nbsp Whe_chg &nbsp Eng_chg &nbsp Govt_ed &nbsp Govt_tax  </p>
 ...
 if(isset($_SESSION["php_table_textbox"]))
{
 ...
 if(array_key_exists('table_btn', $_POST)) {
...
*/
    ...
    else
    {
        ...
        {
            $n++;
            //echo $row['email_id']." ".$row['mobile_no']." ".$row['password'];
            $p1=$row['id'];
            $p2=$row['fixed_charge'];
            $p3=$row['wheeling_charge'];
            $p4=$row['energy_charge'];
            $p5=$row['govt_ed'];
            $p6=$row['govt_tax'];
            
            
            //echo "<br>";
            echo "<p id='title_bg_1_lb'>&nbsp&nbsp&nbsp $p1 &nbsp&nbsp&nbsp&nbsp $p2 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $p3 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $p4 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $p5 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $p6 </p>";
