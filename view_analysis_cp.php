...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <title>View analysis CP - Estimation</title>
    </head>
...
<br>
 ...
 <p id="head_bg"><b> &nbsp &nbsp &nbsp;&nbsp;&nbsp;&nbsp;Analysis Tables  &nbsp</b></p>
 

    <br>
    
    <p id="title_bg_1"> Sr.no &nbsp Tables (Email ID) </p>
...
//For Website estimateelectricitybill.epizy.com
  ...
  */  
    ...
    else
    {
        ...
        $sql= "SHOW TABLES FROM epiz_29239566_analysis;";
