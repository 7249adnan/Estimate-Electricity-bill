...
location.href='forgot_otp_sms.php';
    ...
    <br>               
    <label id="lbl" for="Enter OTP" class="form-label">Enter OTP</label>
   <div class="input-group mb-3 row">
    ...
    <button type="button" name="send_btn" id="send_btn"  onclick="check_number()"  class="btn  btn-outline-success btn-sm "><b>Send OTP</b></button>
...
if(isset($_SESSION["flag_msg"]))
{
    if(($_SESSION["flag_msg"])==1){
        echo '<script>
...
function otp_verify()
{
    if($_SESSION["otp_gen"]!= $_SESSION["php_otp_textbox"])
    {
...
*/
 ...
 ?>
    ...
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="location.href='forgot_number.php';" type="button" id="back"  name="back"  class="btn btn-danger "><b>Back</b> </button>
