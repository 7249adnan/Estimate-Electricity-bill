...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  crossorigin="anonymous"></script>
    ...
    <title> Delete Analysis - Estimation </title>
    </head>
...
var month = new Array();
    ...
    <p id="head_bg"><b>&nbsp&nbsp&nbsp<i class="fa fa-trash-o"></i>&nbsp Delete Month &nbsp</b></p>
    ...
    <div class="input-group mb-3 row">
        ...
        <div class="input-group-prepend">       
            <span id="sp" class="input-group-text" ><i class="fa fa-calendar" style="font-size:20px"></i></span>
...
if(array_key_exists('delete_detail', $_POST)) {
    
   
    $n= delete_data_fun();
    if($n==0){
        echo "<script> document.getElementById('date_msg').innerHTML='<b> This Month And Year Does not Exisit * </b>'</script>";
    }
    else{
...
function delete_data_fun(){
    ...
    */
    ...
    else
    {
        ...
        if($n==1){
            ...
            $sql="DELETE FROM `$email` WHERE `$email`.`id_no` =  '$id_no'";

            $result =mysqli_query($conn,$sql);
            echo "<script>alert('$mon'+ ' Deleted Successfully');</script>";
 ...
 ?>
    ...
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="location.href='analysis_login.php';" class="btn btn-primary"><b><i class="fa fa-arrow-left" style="font-size:18px"></i> &nbsp Back</b></button>
    &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit"  id="delete_detail" name="delete_detail" class="btn btn-danger"><b> <i class="fa fa-trash-o" style="font-size:20px"></i>&nbsp  Delete Month</b></button>
     <br><br>
</form>
